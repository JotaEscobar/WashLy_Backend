...
class CajaSesion(AuditModel):
    ...
    # Detalle en JSON (Ej: {'EFECTIVO': 100, 'YAPE': 50})
...
class Pago(AuditModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # Intentar vincular a caja abierta si no tiene
...
class MovimientoCaja(AuditModel):
    ...
    monto = models.DecimalField(max_digits=10, decimal_places=2)
    metodo_pago = models.CharField(max_length=20, default='EFECTIVO', choices=Pago.METODOS) # Agregado tipo pago
